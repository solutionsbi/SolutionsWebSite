...
export default function Cta() {
    return (
        <section className="page-section">
            ...
            <div className="container relative inset-0 flex max-w-2xl flex-col justify-between rounded-xl border border-white/10 bg-gradient-to-br from-neutral-darkest/60 p-10 shadow-custom before:absolute before:inset-0 before:-z-10 before:backdrop-blur-sm md:p-14 lg:flex-row lg:p-20">
