...
import sectionBg from '@/assets/images/backgrounds/firefly/10.jpg'
import samsumgLogo from '@/assets/images/clientsLogos/samsung.svg'
import ambevLogo from '@/assets/images/clientsLogos/ambev.png'
import abercrombieLogo from '@/assets/images/clientsLogos/abercrombie.svg'
import abrasceLogo from '@/assets/images/clientsLogos/abrasce.png'
import agropalmaLogo from '@/assets/images/clientsLogos/agropalma.svg'
import coplacanaLogo from '@/assets/images/clientsLogos/coplacana.png'
import galzeranoLogo from '@/assets/images/clientsLogos/galzerano.png'
import lifetimeLogo from '@/assets/images/clientsLogos/lifetime.png'
import medicalLogo from '@/assets/images/clientsLogos/medical.png'
import odontoclinicLogo from '@/assets/images/clientsLogos/odontoclinic.png'
import sanavitaLogo from '@/assets/images/clientsLogos/sanavita.png'
import swissLogo from '@/assets/images/clientsLogos/swiss.png'
import datasystemLogo from '@/assets/images/clientsLogos/datasystem.png'
import modazineLogo from '@/assets/images/clientsLogos/modazine.png'
import vrsoftwareLogo from '@/assets/images/clientsLogos/vrsoftware.png'
...
export default function Clients() {
    ...
    useGSAP(
        () => {
            ...
            const sectionLogos = gsap.utils.toArray(
                container.current.querySelectorAll('.client-logo')
            )
    ...
    return (
        <section ref={container} className="page-section bg-neutral-100">
            ...
            <div className="container flex h-full flex-col items-center justify-center">
                <div className="container flex flex-col items-center justify-center text-center">
                    <h2 className="font-inter normal-case">
                ...
                <div className="logos-container relative mx-auto grid w-max grid-cols-2 items-center justify-items-center gap-2 py-16 md:grid-cols-3 lg:grid-cols-4 lg:py-20 xl:grid-cols-5">
                    {clientsLogos.map((client, index) => (
                        <div
                            key={index}
                            className="partner-logo shadow-custom relative grid h-[120px] w-[160px] place-content-center overflow-hidden rounded-[8px] px-6 backdrop-blur md:w-[150px] lg:h-[150px] xl:w-[200px]"
