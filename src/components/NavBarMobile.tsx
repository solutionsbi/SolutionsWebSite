...
import iconEngenhariaDeDados from '@/assets/svg/services-icons/icon-data-engineering.svg'
import iconBusinessIntelligence from '@/assets/svg/services-icons/icon-business-intelligence.svg'
import iconSistemasPersonalizados from '@/assets/svg/services-icons/icon-custom-systems.svg'
import iconInteligenciaArtificial from '@/assets/svg/services-icons/icons-artificial-intelligence.svg'
import iconTransformacaoDigital from '@/assets/svg/services-icons/icon-digital-transformation.svg'
import iconWebsitesEEcommerces from '@/assets/svg/services-icons/icon-websites-ecommerces.svg'
