                ...
                <NavigationMenuItem>
                    ...
                    <NavigationMenuContent>
                        <ul className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px]">
                            {informacoesDeServicos.map((component) => (
                                <ListItem
                                    key={component.title}
                    ...
                    <NavigationMenuContent className="">
                        <ul className="grid w-max gap-3 p-4 lg:grid-cols-[200px_250px]">
                                ...
                                <NavigationMenuLink asChild>
                                    <div className="flex h-full w-full select-none flex-col justify-between rounded-md border-neutral-700 bg-brand-blue bg-gradient-to-b p-4 no-underline outline-none focus:shadow-md">
                                        ...
                                        <p className="text-sm font-normal leading-tight text-neutral-200">
                                            A SolutionsBI é uma empresa de
                                            tecnologia especializada em criar
                                            soluções personalizadas para
                                            empresas que desejam otimizar seus
                                            processos e aumentar sua eficiência.
                                        </p>
                            ...
                            <div className="flex h-full flex-col justify-between">
                                {informacoesDeContato.map((component) => (
                                    <ListItemExternal
                                        key={component.title}
                                        title={component.title}
                                        href={component.href}
