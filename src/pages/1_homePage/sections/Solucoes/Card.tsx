...
export function Card({ title, description, url, icon, img }: Card) {
    return (
        <div className="flex flex-col gap-2">
            <div className="card-bg flex select-none flex-col gap-10 rounded-3xl p-10 lg:h-[450px] xl:h-[400px] 2xl:h-[500px]">
                <div className="flex items-center gap-4">
                    <img className="h-10 w-10" src={icon} alt="" />
                    <h3 className="whitespace-pre-line text-2xl/tight font-semibold">
                        {title}
                    </h3>
                </div>
